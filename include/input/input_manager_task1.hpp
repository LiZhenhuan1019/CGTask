...
{
    class input_manager_task1 : public input_manager
    {
    public:
        input_manager_task1(GLFWwindow *window, render::render_manager &render, camera::free_camera &camera)
        ...
        void scroll_callback(GLFWwindow *, double /*xoffset*/, double yoffset) override
        {
            ...
            {
                camera.go_up((accelerate ? 10 : 1) * yoffset);
            }
        }
    private:
        delta_timer timer;
